...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Asignar profesor a un curso</title>
...
<?php write_user_menu(); ?>
        ...
        <section class="title">
            <div class="container">
                <div class="row-fluid">
                    <div class="span6">
                        <h1>Ingresar Profesor a un Curso</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div  style="margin-top: 50px; margin-bottom: 50px; margin-left: 10%; " >
            <form id="ingresoProfesorCurso"  name="ingresoProfesorCurso" method="post" action="IngresarProfesorCurso.php" onsubmit="return validarSeleccionActualizar()">
                <div>
                    <div class="span5" style="margin-left: 13%; width:87% "> 
                        <label><strong>Profesor</strong></label>
                        <select name="rutJefe" id="rutJefe" style="width: 75%">
                    ...
                    <div class="span5" style="margin-left: 13%; width:87% "> 
                        ...
                        <select name="cursos" id="cursos" style="width: 75%">
                            ...
                            <?php
                            echo seleccionarCursosSinProfe();
                            ?>
                        </select>
                    </div>
                </div>
                <div style="margin-bottom: 50px; margin-left: 13%;"> 
                    <button type="submit" class="btn btn-primary btn-large" style="margin-top: 20px;margin-bottom: 20px; width: 75%">Agregar profesor</button>
                </div> 
            </form>
            <?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                $curso = $_POST['cursos'];
                echo actualizarCurso($rutJefe, $curso);
            }
            ?>
        </div> 
