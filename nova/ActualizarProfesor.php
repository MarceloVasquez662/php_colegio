...
<?php write_user_menu(); ?>
        ...
        $nombre = obtenerNombreProfesor($rutProfesor);
        $direccion = obtenerDireccionProfesor($rutProfesor);
        $correo = obtenerCorreoProfesor($rutProfesor);
        $apellido = obtenerApellidoProfesor($rutProfesor);
        $nacimiento = obtenerNacimientoProfesor($rutProfesor);
        $fecha = obtenerNacimientoProfesor($rutProfesor);
        ?>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            echo actualizarProfesor($profesor);
        }
        ?>    
        <div  style="margin-top: 50px; margin-bottom: 50px; margin-left: 10%; " >
            <form id="ingresoProfesor"  name="ingresoProfesor" method="post" action="ActualizarProfesor.php" onsubmit="return validarIngresoProfesor()">
                <div>
                    <div class="span5">
                        <label><strong>RUT</strong></label>
                        <input type="text" id="rut" name="rut" required="required" placeholder="Ingrese su rut (12.345.678-9)" value="<?php echo $rutProfesor ?>" style="width: 92%" readonly> 
                    ...
                    <div class="span5">
                        ...
                        <input type="date" id="nacimiento" name="nacimiento" required="required" style="width: 92%" value="<?php echo $nacimiento ?>"> 
                    </div>
                </div>
                <div style="margin-bottom: 50px; margin-left: 13%;"> 
                    <button type="submit" class="btn btn-primary btn-large" style="margin-top: 20px;margin-bottom: 20px; width: 75%">Actualizar Profesor</button>
                </div> 
            </form>
        </div> 
