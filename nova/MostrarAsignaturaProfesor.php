...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Mostrar profesor/asignatura</title>
...
<?php write_user_menu(); ?>
        ...
        <div class="" align="center">
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="80%">
                        <tr>
                            <td width="12.5%" bgcolor="grey" align="center" style="color:white">Profesor</td>
                            <td width="12.5%" bgcolor="grey" align="center" style="color:white">Asignatura</td>
                        </tr>
                        <?php
                        seleccionarAsignaturaProfesor();
                        ?> 
            </table>
            <br>
        </div>
