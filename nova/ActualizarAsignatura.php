...
<?php write_user_menu(); ?>
        ...
        $nombre = obtenerNombreAsignatura($IDAsignatura);
        ?>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $nombre = $_POST['nombre'];
            $asignatura = new asignatura($IDAsignatura, $nombre);
            echo actualizarAsignatura($asignatura);
        }
        ?>    
        ...
        <section id="contact-page" class="container">
            <div class="row-fluid">
                <div class="">
                    ...
                    <form id="actualizarAsignatura" name="actualizarAsignatura" method="post" action="ActualizarAsignatura.php" onsubmit="return validarCrearAsignatura()">
                        <div class="row-fluid">
                            <div class="span5">
                                <label>ID Asignatura</label>
                                <input type="text" id="id" name="id" required="required" placeholder="Asignatura" value="<?php echo $IDAsignatura ?>" style="width: 92%" readonly>
                                <label>Nombre</label>
                                <input type="text" id="nombre" name="nombre" required="required" placeholder="Nombre" value="<?php echo $nombre ?>"style="width: 92%" > 
                            </div>   
                        </div>
                        <button type="submit" class="btn btn-primary btn-large" >Actualizar Asignatura</button>
                        <p> </p>
                    </form>
                </div>
            </div>
