...
<?php write_user_menu(); ?>
        ...
        <div  style="margin-top: 50px; margin-bottom: 50px; margin-left: 10%; " >
            <form id="ingresoAlumno"  name="ingresoAlumno" method="post" action="IngresarAlumno.php" onsubmit="return validarIngresoAlumno()">
                <div>
                    <div class="span5">
                        <label><strong>RUT</strong></label>
                        <input type="text" id="rut" name="rut" required="required" placeholder="Ingrese su rut" style="width: 92%" > 
                ...
                <div style="margin-bottom: 50px; margin-left: 13%;">
                    <button type="submit" class="btn btn-primary btn-large" style="margin-top: 20px;margin-bottom: 20px; width: 75%">Insertar Alumno</button>
                </div> 
            </form>
            <?php
