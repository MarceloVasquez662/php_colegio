...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="" align="center">
            <br>
            <form method="post" action="EliminarAsignatura.php">
                <table border="1" cellpadding="0" cellspacing="0" width="80%">
                    <tr>
                        <td width="25%" bgcolor="grey" align="center" style="color:white">Codigo</td>
                        <td width="25%" bgcolor="grey" align="center" style="color:white">Nombre</td>
                        <td width="25%" bgcolor="grey" align="center" style="color:white">Seleccione si desea eliminar</td>
                    </tr>
                    <?php
                    seleccionarAsignaturaEliminar();
                    ?>
                </table>
                <br>
                <div style="margin-bottom: 50px;">
                    <button type="submit" class="btn btn-primary btn-large" style="margin-top: 20px;margin-bottom: 20px; width: 75%">Eliminar Asignaturas</button>
                </div> 
            </form>
            <?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if (!(empty($_POST['asignaturas']))) {
                    foreach ($_POST['asignaturas'] as $eliminados) {
                        eliminarAsignatura($eliminados);
                        $contador++;
                    }
                    $page = 'EliminarAsignatura.php';
                    redirect($page);
                } else {
                    echo '<div class="alert alert-danger" style="width:85%">';
                    echo 'No ha seleccionado asignaturas para eliminar';
                    echo '</div>';
                }
            }
            ?>
