...
<?php write_user_menu(); ?>
    ...
    <section id="contact-page" class="container">
                ...
                <form id="asignaturaProfesor" name="asignaturaProfesor" method="post" action="AsignaturaProfesor.php" onsubmit="return validarAP()">
        <div class="" align="center">
            <br>
            <table border="1" cellpadding="0" cellspacing="0" width="80%">
                        
                        <label>Profesor</label>
                        <select id="rut" name="rut" class="input-block-level">
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == "POST") {
                                    ...
                                    if (!(empty($_POST['asignaturas']))) {
                                        foreach ($_POST['asignaturas'] as $ingresados) {
                                            asignarAsignaturaProfesor($ingresados, $rut);
                                            $contador++;
                                        }
                                        $page='AsignaturaProfesor.php';
                                        redirect($page);
                                    } else {
