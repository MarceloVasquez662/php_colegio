        ...
        <section id="contact-page" class="container">
            <div class="row-fluid">
                <div class="">
                    ...
                    <form id="ingresoAsignatura" name="ingresoAsignatura" method="post" action="IngresarAsignatura.php" onsubmit="return validarCrearAsignatura()">
                        <div class="row-fluid">
                            <div class="span5">
                                <label>ID Asignatura</label>
                                <input type="text" id="asignatura" name="asignatura" class="input-block-level" required="required" placeholder="Asignatura">
                                <label>Nombre</label>
                                <input type="text" id="nombre" name="nombre" class="input-block-level" required="required" placeholder="Nombre">
                            </div>   
                        </div>
                        <button type="submit" class="btn btn-primary btn-large" >Agregar Asignatura</button>
                        <p> </p>
                    </form>
                    <?php
                    if ($_SERVER['REQUEST_METHOD'] == "POST") {
                        ...
                        echo insertarAsignatura($asignatura);
                    }
                    ?>
                </div>
            </div>
