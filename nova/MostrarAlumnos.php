...
<?php write_user_menu(); ?>
        ...
        <div class="" align="center">
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="80%">
                <tr>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">RUT</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Nombre</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Apellido</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Fecha Nacimiento</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Correo</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Direccion</td>
                    <td width="12.5%" bgcolor="grey" align="center" style="color:white">Codigo de curso</td>
                </tr>
                <?php
                seleccionarAlumnos();
                ?> 
