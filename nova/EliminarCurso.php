        ...
        <div class="" align="center">
            ...
            <form method="post" action="EliminarCurso.php">
                <table border="1" cellpadding="0" cellspacing="0" width="80%">
                    <tr>
                        <td width="18.75%" bgcolor="grey" align="center" style="color:white">Codigo</td>
                        <td width="18.75%" bgcolor="grey" align="center" style="color:white">Nombre</td>
                        <td width="18.75%" bgcolor="grey" align="center" style="color:white">Profesor Jefe</td>
                        <td width="18.75%" bgcolor="grey" align="center" style="color:white">Seleccione si desea eliminar</td>
                    </tr>
                    <?php
                    seleccionarCursosEliminar();
                    ?>
                </table>
                <br>
                <div style="margin-bottom: 50px;">
                    <button type="submit" class="btn btn-primary btn-large" style="margin-top: 20px;margin-bottom: 20px; width: 75%">Eliminar Cursos</button>
                </div> 
            </form>
            <?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if (!(empty($_POST['cursos']))) {
                    foreach ($_POST['cursos'] as $eliminados) {
                        eliminarCurso($eliminados);
                        $contador++;
                    }
                    $page = 'EliminarCurso.php';
                    redirect($page);
                } else {
                    echo '<div class="alert alert-danger" style="width:85%">';
                    echo 'No ha seleccionado cursos para eliminar';
                    echo '</div>';
                }
            }
            ?>
