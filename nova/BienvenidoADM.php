            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <h2>Todas las opciones estan en la barra de navegacion en la parte superior.</h2>
                    </div>
                </div>
            </div>
        </section>
        <!-- / .title -->
        <div  style="margin-top: 50px; margin-bottom: 20px; margin-left: 15%;padding-right: 40px;" >
            <form id="login-form" class="contact-form" name="login-form" method="post" action="">
                <div>
                    <div class="span5">
                    </div> 
                </div>
